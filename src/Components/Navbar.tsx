...
function Navbar() {
  ...
  return (
    <>
      <nav className="relative mx-auto flex w-11/12 items-center justify-between  px-2 py-8 max-sm:px-0">
      ...
      {toggle ? (
        <div className="hidden px-6 max-[500px]:block">
          <div className="flex h-[200px] w-full items-center justify-center rounded-2xl bg-zinc-800">
            <Navlink href={`/movies`} Navtext={`Movies`}></Navlink>
          </div>
        </div>
      ) : (
        ""
